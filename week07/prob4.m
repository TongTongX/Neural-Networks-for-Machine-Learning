...
function [dE0dz0] = get_dE0dz0(y_0, t_0, w_hy, h_0)
	dE0dy0 = y_0 - t_0;
	dy0dh0 = w_hy;
	dh0dz0 = h_0 * (1 - h_0);
	dE0dz0 = dE0dy0 * dy0dh0 * dh0dz0;
endfunction
...
function [dE2dz2] = get_dE2dz2(y_2, t_2, w_hy, h_2)
	dE2dy2 = y_2 - t_2;
	dy2dh2 = w_hy;
	dh2dz2 = h_2 * (1 - h_2);
	dE2dz2 = dE2dy2 * dy2dh2 * dh2dz2;
endfunction

function [dE1dz0] = get_dE1dz0(y_1, t_1, w_hy, h_1, w_hh, h_0)
	dE1dz1 = get_dE1dz1(y_1, t_1, w_hy, h_1);
	dz1dh0 = w_hh;
	dh0dz0 = h_0 * (1 - h_0);
	dE1dz0 = dE1dz1 * dz1dh0 * dh0dz0;
endfunction

function [dE2dz1] = get_dE2dz1(y_2, t_2, w_hy, h_2, w_hh, h_1)
	dE2dz2 = get_dE2dz2(y_2, t_2, w_hy, h_2);
	dz2dh1 = w_hh;
	dh1dz1 = h_1 * (1 - h_1);
	dE2dz1 = dE2dz2 * dz2dh1 * dh1dz1;
endfunction

function [dE2dz0] = get_dE2dz0(y_2, t_2, w_hy, h_2, w_hh, h_1, h_0)
	dE2dz1 = get_dE2dz1(y_2, t_2, w_hy, h_2, w_hh, h_1);
	dz1dh0 = w_hh;
	dh0dz0 = h_0 * (1 - h_0);
	dE2dz0 = dE2dz1 * dz1dh0 * dh0dz0;
endfunction
...
dE0dz0 = get_dE0dz0(y_0, t_0, w_hy, h_0);
dE1dz1 = get_dE1dz1(y_1, t_1, w_hy, h_1);
dE2dz2 = get_dE2dz2(y_2, t_2, w_hy, h_2);
dE1dz0 = get_dE1dz0(y_1, t_1, w_hy, h_1, w_hh, h_0);
dE2dz1 = get_dE2dz1(y_2, t_2, w_hy, h_2, w_hh, h_1);
dE2dz0 = get_dE2dz0(y_2, t_2, w_hy, h_2, w_hh, h_1, h_0);

dEdz0 = dE0dz0 + dE1dz0 + dE2dz0
dEdz1 = dE1dz1 + dE2dz1
dEdz2 = dE2dz2
